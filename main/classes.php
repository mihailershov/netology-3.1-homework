...
<body>
<h1>Инкапсуляция</h1>
<p>Инкапсуляция - это когда мы объединяем в одну сущность участки кода, относящиеся к одному контексту, и закрываем доступ к наиболее важным свойствам и методам.</p>
<h1>Об объектах</h1>
...
<p>Естественно, почитал и на сторонних ресурсах о плюсах и минусах использования классов, но пока ограничусь теми фактами, которые сам лично заметил при работе с классами.</p>
